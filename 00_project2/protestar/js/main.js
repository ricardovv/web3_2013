...
$( "select" ).change(function () {
	...
	//LANDSCAPE
	if($("#selbg").val() == "bg_1"){
		$("#bg").css('background', 'Url(img/bg_1.gif)'); 
	}
	if($("#selbg").val() == "bg_2"){
		$("#bg").css('background', 'Url(img/bg_2.gif)'); 
	}
	if($("#selbg").val() == "bg_3"){
		$("#bg").css('background', 'Url(img/bg_3.gif)'); 
	}
	if($("#selbg").val() == "bg_4"){
		$("#bg").css('background', 'Url(img/bg_4.gif)'); 
	}
	if($("#selbg").val() == "bg_0"){
...
// 		var newtext = $('inputmessage').val(); //get text value from input	
// 			val_cmessage = newtext;
// 		$('#cartel h2').text("! " + newtext + " !");
...
//			document.getElementById("allselect").submit();
	...
	//R - U S E R   W E B S I T E  O N B G / NOT IN USE - - - - - - - - - - - - - - - - - - - - - - - - //	
